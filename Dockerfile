...
RUN apk upgrade --no-cache && \
    apk add --no-cache dumb-init shadow libpng libpng-dev libjpeg-turbo libjpeg-turbo-dev freetype freetype-dev curl autoconf libgomp icu-dev icu-data-full nginx dcron tzdata imagemagick imagemagick-dev libzip-dev postgresql-dev libwebp-dev && \
