    ...
    <section class="account-section">
        ...
        <div class="payments-list" id="payments-list">
            ...
            foreach ($payments as $payment) {
                // Resolve payment method icon URL
                $paymentIconUrl = $payment['icon'];
                if (strpos($paymentIconUrl, 'images/uploads/icons/') !== 0) {
                    $base = basename($paymentIconUrl);
                    $paymentIconUrl = (storage_driver() === 'supabase') ? storage_public_url('logos/' . $base) : ('images/uploads/logos/' . $base);
                }
                ...
                <div class="payments-payment" data-enabled="<?= $payment['enabled']; ?>"
                    ...
                    <img src="<?= $paymentIconUrl ?>" alt="Logo" />
