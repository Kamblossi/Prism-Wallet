  ...
  <div class="subscriptions" id="subscriptions">
    ...
    foreach ($subscriptions as $subscription) {
      ...
      if (!empty($subscription['logo'])) {
        ...
        $print[$id]['logo'] = (storage_driver() === 'supabase') ? storage_public_url('logos/' . $file) : ('images/uploads/logos/' . $file);
      } else {
        $print[$id]['logo'] = '';
      }
      ...
      if (strpos($pmIconVal, 'images/uploads/icons/') === 0) {
        $print[$id]['payment_method_icon'] = $pmIconVal;
      } else {
        $pmIconBase = basename($pmIconVal);
        $print[$id]['payment_method_icon'] = (storage_driver() === 'supabase') ? storage_public_url('logos/' . $pmIconBase) : ('images/uploads/logos/' . $pmIconBase);
      }
